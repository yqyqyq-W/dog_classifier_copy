...
def main():
    ...
    tr_loader, va_loader, te_loader, _ = get_train_val_test_loaders(
        task="source",
        batch_size=config("challenge_source.batch_size"),
    )
    ...
    optimizer = torch.optim.AdamW(model.parameters(), lr=1e-3, weight_decay=0.0001, betas=(0.5, 0.99))
    ...
    epoch = start_epoch
    while curr_patience < patience and epoch < 50:
        # Train model
